"""Structural tests for the file-annual-return-south-africa scaffold.
...
from server import check_due_date, get_status  # noqa: E402


class TestScaffoldHonesty:
    async def test_get_status_reports_scaffold(self):
        s = await get_status()
        assert s["skill"] == "file-annual-return-south-africa"
...
def test_mcp_server_starts():
    ...
    assert mcp.name == "mia-file-annual-return-south-africa"
